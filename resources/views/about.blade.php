...
.page::after{
    ...
    animation:pageLight 5s ease-in-out infinite;
...
<div class="page">
    ...
    <div class="header">
        ...
        <p>
            تجربة مسرحية من عالم قريب جدًا
        </p>
    ...
    <div class="card">
        ...
        <p>
            صُنّاع مسرحية
            <span class="highlight">"مصاص الدماء"</span>،
            <span class="highlight">"زمن دراكولا"</span>،
            <span class="highlight">"خطوات الشيطان"</span>
            و
        ...
        <p>
            ...
            <span class="highlight">
                استبدال الأب بروبوت رجل آلي يشبهه.
            </span>
        </p>
